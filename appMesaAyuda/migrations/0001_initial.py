# Generated by Django 4.2.13 on 2024-07-17 03:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('solCaso', models.ForeignKey(db_comment='Hace referencia al caso que genera la solución', on_delete=django.db.models.deletion.PROTECT, to='appMesaAyuda.caso')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('solSolucionCaso', models.ForeignKey(db_comment='Hace referencia a la solución del Caso', on_delete=django.db.models.deletion.PROTECT, to='appMesaAyuda.solucioncaso')),
                ('solTipoProcedimiento', models.ForeignKey(db_comment='Hace referencia al tipo de procedimiento de la solución', on_delete=django.db.models.deletion.PROTECT, to='appMesaAyuda.tipoprocedimiento')),
            ],
        ),
        migrations.CreateModel(
            name='Solicitud',
            fields=[
                ...
                ('fechaHoraCreacion', models.DateField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('solOficinaAmbiente', models.ForeignKey(db_comment='Hace referencia a la oficina o ambiente donde se encuentra el equipo de la solicitud', on_delete=django.db.models.deletion.PROTECT, to='appMesaAyuda.oficinaambiente')),
        ...
        migrations.AddField(
            model_name='caso',
            name='casSolicitud',
            field=models.ForeignKey(db_comment='Hace referencia a la solicitud que generó el Caso', on_delete=django.db.models.deletion.PROTECT, to='appMesaAyuda.solicitud'),
        ),
        migrations.AddField(
            model_name='caso',
            name='casUsuario',
