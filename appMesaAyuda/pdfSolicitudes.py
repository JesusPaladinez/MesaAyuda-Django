...
class Pdf(FPDF):
    def header(self):
        # Logo
        self.image('media/logoSenaVerde.png', 10, 8, 33)
        # Arial bold 15
    ...
    def mostrarDatos(self, solicitudes):
        ...
        for solicitud in solicitudes:
            self.cell(40, 10, f'{solicitud.solUsuario.first_name} {solicitud.solUsuario.last_name}', 1, 0, 'L')
        ...
        self.ln()
        self.set_font('Arial', 'B', 12)
        self.cell(200, 10, '______________________________________', 0, 0, 'C')
        self.ln()
