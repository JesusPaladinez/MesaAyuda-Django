...
from appMesaAyuda.models import *
from random import *
...
from appMesaAyuda.serializers import OficinaAmbienteSerializer, UserSerializer
...
def generarPdfSolicitudes(request):
    ...
    from appMesaAyuda.pdfSolicitudes import Pdf
